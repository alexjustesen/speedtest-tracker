...
class SendSpeedtestThresholdNotification
{
    ...
    public function handle(SpeedtestCompleted $event): void
    {
        ...
        if (! $notificationSettings->teams_on_threshold_failure) {
            return;
        }
        ...
        if (! count($failed)) {
            Log::warning('Failed Teams thresholds not found, won\'t send notification.');

            return;
        }

        $payload = [
            'text' => view('teams.speedtest-threshold', [
                'id' => $event->result->id,
    ...
    /**
     * Build Teams notification if absolute download threshold is breached.
     */
    ...
    /**
     * Build Teams notification if absolute upload threshold is breached.
     */
    ...
    /**
     * Build Teams notification if absolute ping threshold is breached.
     */
