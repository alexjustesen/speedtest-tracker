                                                ...
                                                Fieldset::make(__('settings/thresholds.metrics'))
                                                    ->schema([
                                                        TextInput::make('absolute_download')
                                                            ->label(__('settings/thresholds.absolute_download'))
                                                            ->hint(__('settings/thresholds.mbps'))
                                                        ...
                                                        TextInput::make('absolute_upload')
                                                            ->label(__('settings/thresholds.absolute_upload'))
                                                            ->hint(__('settings/thresholds.mbps'))
                                                            ->helperText(__('settings/thresholds.metrics_helper_text'))
                                                            ->default(0)
                                                            ->minValue(0)
                                                        ...
                                                        TextInput::make('absolute_ping')
                                                            ->label(__('settings/thresholds.absolute_ping'))
                                                            ->hint(__('settings/thresholds.ms'))
                                                            ->helperText(__('settings/thresholds.metrics_helper_text'))
                                                            ->default(0)
                                                            ->minValue(0)
                                                            ->numeric()
